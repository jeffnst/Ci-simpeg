...
table = $('#table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('master_jabatan/ajax_list');?>",
        "type": "POST"
    },
...
$.ajax({
    url : "<?php echo site_url('master_jabatan/ajax_edit/')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
        ...
        $('[name="id"]').val(data.id);
        $('[name="nama_jabatan"]').val(data.jenis_jabatan);
...
if(save_method == 'add') {
    url = "<?php echo site_url('master_jabatan/ajax_add')?>";
} else {
    url = "<?php echo site_url('master_jabatan/ajax_update')?>";
}
...
if(confirm('Are you sure delete this data?'))
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_jabatan/ajax_delete')?>/"+id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
