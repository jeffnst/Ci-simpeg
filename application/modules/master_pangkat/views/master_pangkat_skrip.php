...
table = $('#table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('master_pangkat/ajax_list');?>",
        "type": "POST"
    },
...
$.ajax({
    url : "<?php echo site_url('master_pangkat/ajax_edit/')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
        ...
        $('[name="level_pangkat"]').val(data.level_pangkat);
...
if(save_method == 'add') {
    url = "<?php echo site_url('master_pangkat/ajax_add')?>";
} else {
    url = "<?php echo site_url('master_pangkat/ajax_update')?>";
}
...
if(confirm('Are you sure delete this data?'))
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_pangkat/ajax_delete')?>/"+id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
