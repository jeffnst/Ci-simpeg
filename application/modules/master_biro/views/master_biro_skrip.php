...
table = $('#table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('master_biro/ajax_list');?>",
        "type": "POST"
    },
...
$.ajax({
    url : "<?php echo site_url('master_biro/ajax_edit/')?>/" + id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
        ...
        $('[name="id"]').val(data.id);
        $('[name="urut_biro"]').val(data.urut_biro);
        $('[name="kode_biro"]').val(data.kode_biro);
        $('[name="nama_biro"]').val(data.nama_biro);
...
if(save_method == 'add') {
    url = "<?php echo site_url('master_biro/ajax_add')?>";
} else {
    url = "<?php echo site_url('master_biro/ajax_update')?>";
}
...
if(confirm('Are you sure delete this data?'))
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_biro/ajax_delete')?>/"+id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
