...
table = $('#table').DataTable({
    ...
    "ajax": {
        "url": "<?php echo site_url('master_status/ajax_list');?>",
        "type": "POST"
    },
...
$.ajax({
    url : "<?php echo site_url('master_status/ajax_edit/')?>/" + id,
    type: "GET",
    dataType: "JSON",
...
if(save_method == 'add') {
    url = "<?php echo site_url('master_status/ajax_add')?>";
} else {
    url = "<?php echo site_url('master_status/ajax_update')?>";
}
...
if(confirm('Are you sure delete this data?'))
{
    ...
    $.ajax({
        url : "<?php echo site_url('master_status/ajax_delete')?>/"+id,
        type: "POST",
        dataType: "JSON",
        success: function(data)
        {
