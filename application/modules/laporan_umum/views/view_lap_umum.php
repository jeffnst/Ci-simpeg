        ...
        <h1 style="font-size:20pt">Laporan Total Pegawai </h1>
        ...
        <a href= "<?php echo base_url('laporan_umum/export_excel') ?>" class="btn btn-raised btn-sm btn-warning"><i class="fa fa-file-excel-o"></i> Export Excel</a>
        <br />
        <br />
